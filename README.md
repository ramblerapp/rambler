## Rambler
A web browser extension for desktop and Android for new, helpful features for Rumble live streams.


## What is it?
This is a browser extension that adds extra functionality to Rumble videos and livestreams.
...
4) you should see Rambler 1.0.0 active on this screen.
...
View previously saved chat on past streams from Rumble or Twitch:
1a) watch a stream and save the chat using this extension
1b) or have someone give you the exported chat file
2) upload your video of the stream to Rumble
3) load the video on Rumble. You can manually import the chat to view on the side using this extension drop down menu


Usage on livestreams:
Load an active livestream with chat on Rumble:
...
- if puzzle piece, click on the pin icon next to the Rambler green keyboard icon.
...
- the magnifying glass + is to toggle searching of all saved stream chats on this device from Rumble
...
- When the search menu is hidden, the main menu icons work on the chat appearing in the Rumble sidebar
...
turn on press @ in chat to bring up a mention menu
press on chat messages to mention that user in chat
